...
void addEdge(struct Graph* graph, int src, int dest, int weight)
{
	...
	*/  //the caller will add each edge twice
}
...
void PrimMST(struct Graph* graph, struct Graph* res)
{
	...
	//restore the result into a graph structure
	for (int i = 1; i < V; ++i){
		addEdge(res, parent[i], i, key[i]);
